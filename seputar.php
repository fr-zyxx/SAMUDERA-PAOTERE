...
<!-- HEADER -->
    ...
    <!-- navbar -->
    <div class="fixed-top">
      <nav class="navbar navbar-expand-lg navbar-dark warna-04304D">
  ...
  <section>
    <div class="container-fluid">
      <div class="row justify-content-center align-items-center">
        ...
        <!-- Konten coming soon -->
        <div class="container-fluid">
            <img src="img/pao.jpg" alt="" width="700" height="500" class="d-inline-block align-text-top">
        </a>
        <h1 class="text-dark" class="fs-6">Pelabuhan Paotere memiliki tempat tersendiri dalam sejarah Kota Makassar. Terletak di bagian utara (tepatnya Kelurahan Gusung, Kecamatan Ujung Tanah), masyarakat mengenalnya sebagai bandar perahu rakyat. <span>
...
Nah, daerah sekitar Paotere pun jadi pusat seafood andalan masyarakat Makassar</h1>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <!-- ikuti kami-->
          ...
          <div class="my-4">
            <ul class="list-unstyled">
              <li>
                <a href="#"><i class="fa-5x fab fa-facebook text-white mr-3"></i></a>
                <a href="#"><i class="fa-5x fab fa-youtube text-white"></i></a>
              </li>
              <br>
              <li>
                <a href="#"><i class="fa-5x fab fa-instagram text-white mr-4"></i></a>
                <a href="#"><i class="fa-5x fab fa-spotify text-white"></i></a>
              </li>
            </ul>
          </div>
        ...
        <div class="col-md-4 text-left text-md-left">
          ...
          <div class="my-3">
            <p class="text-white font-weight-bold text-center pr-5" style="font-size:17px">Kategori</p>
          </div>
          ...
          <div class="my-4">
            <div class="footer-widget">
              <div class="footer-widget-heading">
                <ul class="list-unstyled">
                  <li><a href="#" class="text-white" style="font-size:14px">Tentang Kami</a></li>
                  <li><a href="#" class="text-white" style="font-size:14px">Arsip</a></li>
                  <li><a href="#" class="text-white" style="font-size:14px">Berita </a></li>
                  <li><a href="#" class="text-white" style="font-size:14px">Pedoman Media</a></li>
                  <li><a href="#" class="text-white" style="font-size:14px">Lensa Daerah</a></li>
                  <li><a href="#" class="text-white" style="font-size:14px">Koran Terkini</a></li>
                  <li><a href="#" class="text-white" style="font-size:14px">Berita Lainnya..</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <form class="" method="POST" action="">
            <div class="form-group">
              <i class="fas fa-search"></i>
                <input type="text" class="form-control custom-input" name="search" value="" placeholeder"Cari disini" id="search">
            </div>
          </form>
          <!-- end pencarian -->
