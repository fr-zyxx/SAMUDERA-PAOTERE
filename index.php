  ...
  <section>
    <div class="container-fluid">
      <div class="row justify-content-center align-items-center">
        ...
        <!-- Konten coming soon -->
        <h1 class="display-2 text-capitalize text-center" style="color: darkgreen;">
          <div id="flip">
            <div><div><span>SAMUDERA PAOTERE</span></div></div>
            <div><div><span class="font-weight-bold">COMING SOON</span></div></div>
          </div>
        </h1>
