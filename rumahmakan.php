  ...
  <section>
    <div class="container-fluid">
      <div class="row justify-content-center align-items-center">
        ...
        <!-- Konten coming soon -->
        <div class="container-fluid">
            <img src="img/rmpaotere.jpg" alt="" width="700" height="500" class="d-inline-block align-text-top">
        </a>
        <h1 class="text-dark" class="fs-6"> <br> Rumah Makan Paotere merupakan salah satu rumah makan yang terletak di sekitaran pelabuhan paotere. </h1>
        </div>
