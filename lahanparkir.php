  ...
  <section>
    <div class="container-fluid">
      <div class="row justify-content-center align-items-center">
        ...
        <!-- Konten coming soon -->
        <div class="container-fluid">
            <img src="img/parkiran.jpg" alt="" width="700" height="500" class="d-inline-block align-text-top">
        </a>
        <h1 class="text-dark" class="fs-6"> <br> Lahan parkir di pelabuhan paotere biasanya dikenakan harga tarif <br> Motor = Rp.2000 <br> Mobil = Rp.3000. </h1>
        </div>
