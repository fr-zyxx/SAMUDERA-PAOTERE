  ...
  <section>
    <div class="container-fluid">
      <div class="row justify-content-center align-items-center">
        ...
        <!-- Konten coming soon -->
        <div class="container-fluid">
            <img src="img/gb1.jpg" alt="" width="700" height="500" class="d-inline-block align-text-top">
        </a>
        <h1 class="text-dark" class="fs-6"> <br> Gerbang 1 Paotere merupakan salah satu jalan masuk untuk menuju ke pelabuhan atau ke pangkalan kapal. </h1>
        </div>
